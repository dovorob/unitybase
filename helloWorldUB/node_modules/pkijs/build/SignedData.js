...
var _AttributeCertificateV = require("./AttributeCertificateV1");

var _AttributeCertificateV2 = _interopRequireDefault(_AttributeCertificateV);

var _AttributeCertificateV3 = require("./AttributeCertificateV2");
			...
			if ("SignedData.certificates" in asn1.result) {
				this.certificates = Array.from(asn1.result["SignedData.certificates"], function (certificate) {
					switch (certificate.idBlock.tagClass) {
						case 1:
							return new _Certificate2.default({ schema: certificate });
						case 3:
							{
								var tagNumber = certificate.idBlock.tagNumber;
								...
								switch (tagNumber) {
									...
									case 1:
										return new _AttributeCertificateV2.default({ schema: certificate });
									//endregion
									//region AttributeCertificateV2
									case 2:
										return new _AttributeCertificateV4.default({ schema: certificate });
									//endregion
