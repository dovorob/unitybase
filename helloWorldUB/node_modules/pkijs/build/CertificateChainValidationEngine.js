   ...
   */
	...
	_createClass(CertificateChainValidationEngine, [{
		...
		value: function defaultFindOrigin(certificate, validationEngine) {
			...
			try {
				for (var _iterator = this.certs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
			...
			try {
				for (var _iterator2 = this.trustedCerts[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
